...
class AddFollowedByRelationship
{
    ...
    {
        if ($event->isRelationship(CurrentUserSerializer::class, 'followedBy')) {
            return $event->serializer->hasMany($event->model, UserSerializer::class, 'followedBy');
        }
    }
